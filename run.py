...
def calculate_surplus_data(sales_row):
    ...
    The surpluss is defined as the sales figures substract from the stock:
    - Positive surpls indicates waste
    - Negative surpluss indictaed extra made when stock was sold out.
    """
